...
<div class="container-fluid">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="list-grid-toggle d-flex align-items-center mr-3">
                                <div data-toggle-extra="tab" data-target-extra="#table" class="mr-2 active">
                                    <div class="grid-icon">
    ...
    <div id="table" class="item-content animate__animated animate__fadeIn active"
    ...
    function createProjectForm() {
        ...
        $.ajax({
            ...
            success: function(data) {
                window.LaravelDataTables["project-table"].draw();
            ...
            error: function(xhr, status, error) {
                ...
                errorMessage.innerHTML = xhr.responseJSON.message || 'An error occurred. Please try again.';
            }
        });
    }
